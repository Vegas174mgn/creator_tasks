...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/Site2/about/idea/",
            "PATH_IDEA_POST" => "/Site2/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/Site2/login/?forgot_password=yes",
            "REGISTER_URL" => "/Site2/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
